...
export const blogPosts: BlogPost[] = [
  {
    title: "What's Lurking Behind the Hallucinations in LLMs?",
    slug: "whats-lurking-behind-hallucinations",
    date: "2024-03-12",
    author: "Kapil Jain",
    excerpt: "Exploring the fundamental mechanics of Large Language Models and why hallucinations are an inherent feature of their design, not just a bug.",
    externalLink: "https://www.linkedin.com/pulse/whats-lurking-behind-hallucinations-llms-kapil-jain-eyecf"
  },
  {
    title: "A Curious Obituary to the Software Org Chart",
    slug: "curious-obituary-software-org-chart",
    date: "2024-02-15",
    author: "Kapil Jain",
    excerpt: "Reflecting on how AI coding agents and modern development paradigms are dismantling traditional software engineering organizational structures.",
    externalLink: "https://www.linkedin.com/pulse/curious-obituary-software-org-chart-kapil-jain-voh3c"
  },
  {
    title: "The Problem with Remembering",
    slug: "problem-remembering",
    date: "2024-01-20",
    author: "Kapil Jain",
    excerpt: "An analysis of context windows, RAG architectures, and the challenges AI faces when trying to maintain long-term memory in enterprise applications.",
    externalLink: "https://www.linkedin.com/pulse/problem-remembering-kapil-jain-rixuf"
  },
  {
