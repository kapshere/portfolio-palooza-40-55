  ...
  return (
    <section id="about" className="py-16 bg-gray-50 dark:bg-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-center text-primary dark:text-white mb-12">About Me</h2>
        
        <Card className="mb-6 dark:bg-gray-900 dark:border-gray-700">
          <CardContent className="prose prose-lg max-w-none pt-6">
            <p className="text-left md:text-justify text-gray-700 dark:text-gray-300">
            ...
            <p className="mt-4 text-left md:text-justify text-gray-700 dark:text-gray-300">
